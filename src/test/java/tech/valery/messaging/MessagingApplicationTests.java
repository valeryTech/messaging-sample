...
import tech.valery.messaging.data.Message;
...
public class MessagingApplicationTests {
	...
	public void getJoesInbox() throws Exception {
		...
		assertThat(messages).extracting(m-> m.getSummary()).containsOnly("Hello Jane","Greetings Jane", "Is this secure?");
	}
	...
	public void getJoesSent() throws Exception {
		...
		assertThat(messages).extracting(m-> m.getSummary()).containsOnly("Hello Bill","How are you Bill?", "Is this secure?","Greetings Admin");
	}
	...
	public void getMessage() throws Exception {
		...
		assertThat(message.getSummary()).isEqualTo("Greetings Jane");
	}
	...
	public void getUsers() throws Exception {
		...
		assertThat(messages).extracting(m-> m.getEmail()).containsOnly("bill@example.com","jane@example.com", "admin@example.com");
	}
